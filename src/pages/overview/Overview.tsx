      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {canCreateJD && (
            ...
            >
              <Plus size={13} /> <span className="hidden sm:inline">Job Direction</span><span className="sm:hidden">JD</span>
            </button>
          )}
          {canCreateTasks && (
            <button
            ...
            >
              <Plus size={13} /> <span className="hidden sm:inline">New Task</span><span className="sm:hidden">Task</span>
            </button>
          )}
        </div>
      </div>
